...
func TestNewTurnFunc_ReturnsText(t *testing.T) {
	turn := newTurnFunc(testPackFile, testAgentName, mockOpts(), nil, nil)
...
func TestNewTurnFunc_BadPackPath(t *testing.T) {
	turn := newTurnFunc("testdata/does-not-exist.pack.json", testAgentName, mockOpts(), nil, nil)
...
func TestNewStreamFunc_StreamsText(t *testing.T) {
	stream := newStreamFunc(testPackFile, testAgentName, mockOpts(), nil, nil)
...
func TestNewStreamFunc_BadPackPath(t *testing.T) {
	stream := newStreamFunc("testdata/does-not-exist.pack.json", testAgentName, mockOpts(), nil, nil)
